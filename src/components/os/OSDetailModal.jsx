...
import OSDocumentoView from './OSDocumentoView';
          ...
          <div className="p-6">
            <Tabs defaultValue="detalhes">
              <TabsList className="mb-6">
                ...
                {isExpedicao && (
                  <TabsTrigger value="documento" onClick={() => handleTabChange('documento')}>Documento</TabsTrigger>
                )}
                {isRecebimento && (
              ...
              {/* Documento Tab (Expedição) */}
              {isExpedicao && (
                <TabsContent value="documento" className="space-y-4">
                  <OSDocumentoView os={localOS} instalacoes={instalacoes} />
                </TabsContent>
              )}
              ...
              {/* Histórico Tab */}
              <OSHistoricoTab
                loaded={loadedTabs.has('historico')}
                auditLogs={auditLogs}
                auditPage={auditPage}
