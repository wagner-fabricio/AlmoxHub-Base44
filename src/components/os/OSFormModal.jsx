...
export default function OSFormModal({
  ...
  return (
    <Dialog open={open} onOpenChange={(o) => { if (!o) handleCloseRequest(); }}>
      <DialogContent className={`${(usaFluxoExpedicao || usaFluxoRecebimento) ? 'max-w-[1150px]' : 'max-w-5xl'} w-[calc(100vw-1rem)] sm:w-full max-h-[95vh] sm:max-h-[90vh] p-0 gap-0 flex flex-col overflow-hidden`} aria-describedby={undefined}>
