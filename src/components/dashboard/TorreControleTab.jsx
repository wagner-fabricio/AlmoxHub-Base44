...
import { Package, TrendingUp, DollarSign, ClipboardList, Timer, HelpCircle } from 'lucide-react';
      ...
      <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto">
        ...
        <div className="space-y-5 text-sm">
          {[
            ...
            {
              num: 5, sigla: 'No Prazo', titulo: 'OS Dentro do Prazo',
            ...
            {
              num: 6, sigla: 'Fora do Prazo', titulo: 'OS Fora do Prazo',
            ...
            {
              num: 7, sigla: 'Gráficos Mensais', titulo: 'Evolução Mensal por Prazo (OS, Valor e Peso)',
              desc: 'Todos os gráficos de barras mensais agrupam as OS criadas no ano corrente, mês a mês, classificando-as entre "No Prazo" e "Fora do Prazo" com base nas regras acima. Os percentuais exibidos dentro das barras representam a proporção de cada status em relação ao total do mês.',
