      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        <TabsContent value="torre" className="mt-6 space-y-8">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              {/* Gráfico de Barras Mensais - Itens */}
              <Card className="bg-white dark:bg-slate-800 lg:col-span-2">
                <CardHeader>
                  <CardTitle className="text-lg font-semibold flex items-center gap-2">
                    <Package className="w-5 h-5 text-purple-500" />
                    Total de Itens por Prazo - Ano Corrente
                  </CardTitle>
                </CardHeader>
                <CardContent>
                {(() => {
                  ...
                  const dadosMensais = meses.map((mes, index) => {
                    ...
                    return {
                      mes,
                      'No Prazo': itensNoPrazo,
                      'Fora do Prazo': itensForaPrazo
                    };
                  });
              ...
              {/* Gráfico de Rosca - Total Anual de Itens */}
              <Card className="bg-white dark:bg-slate-800">
                <CardHeader>
                  <CardTitle className="text-lg font-semibold flex items-center gap-2">
                    <Package className="w-5 h-5 text-purple-500" />
                    Resumo Anual de Itens
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  {(() => {
                    ...
                    const dadosRosca = [
                      { name: 'No Prazo', value: totalItensNoPrazo, color: '#22c55e' },
                      { name: 'Fora do Prazo', value: totalItensForaPrazo, color: '#ef4444' }
                    ].filter(d => d.value > 0);
                    
                    const total = totalItensNoPrazo + totalItensForaPrazo;
                    ...
                    const percentualNoPrazo = ((totalItensNoPrazo / total) * 100).toFixed(2);
                      ...
                      <div className="flex flex-col items-center justify-center h-full">
                        ...
                        <div className="mt-6 space-y-2 w-full px-4">
                          <div className="flex items-center justify-between text-sm">
                            ...
                            <span className="font-semibold text-slate-900 dark:text-white">{totalItensNoPrazo.toLocaleString('pt-BR')}</span>
                          </div>
                          ...
                          <div className="flex items-center justify-between text-sm">
                            ...
                            <span className="font-semibold text-slate-900 dark:text-white">{totalItensForaPrazo.toLocaleString('pt-BR')}</span>
                          </div>
                        </div>
                      </div>
                    );
