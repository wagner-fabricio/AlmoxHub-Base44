        ...
        <Card className="bg-white dark:bg-slate-800">
          ...
          <CardContent>
            {osByCategoria.length > 0 ? (
              <ResponsiveContainer width="100%" height={Math.max(320, osByCategoria.length * 36)}>
                <BarChart data={osByCategoria} layout="vertical" margin={{ top: 10, right: 40, left: 8, bottom: 0 }}>
                  ...
                  <Bar dataKey="total" fill="#0000FF" radius={[0, 6, 6, 0]} barSize={18} label={{ position: 'right', fill: '#475569', fontSize: 12, fontWeight: 600 }} />
                </BarChart>
              </ResponsiveContainer>
            ) : (
              <div className="h-72 flex items-center justify-center text-slate-400">
