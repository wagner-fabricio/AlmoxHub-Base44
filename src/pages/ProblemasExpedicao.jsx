...
export default function ProblemasExpedicao() {
  ...
  const loadData = async () => {
    try {
      ...
      const problemasData = await base44.entities.ProblemaExpedicao.list('-created_date');
  ...
  const handleSave = async () => {
    ...
    try {
      if (editingProblema) {
        await base44.entities.ProblemaExpedicao.update(editingProblema.id, formData);
        toast.success('Problema atualizado com sucesso');
      } else {
        await base44.entities.ProblemaExpedicao.create(formData);
  ...
  const handleDelete = async () => {
    ...
    try {
      await base44.entities.ProblemaExpedicao.delete(problemaToDelete.id);
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-1">
            Cadastro de problemas comuns no processo de expedição
          </p>
        </div>
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="Ex: Separação - Item em falta no estoque"
